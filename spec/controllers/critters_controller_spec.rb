...
RSpec.describe CrittersController, type: :controller do
  ...
  # CrittersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested critter as @critter" do
      critter = Critter.create! valid_attributes
      get :show, {:id => critter.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested critter as @critter" do
      critter = Critter.create! valid_attributes
      get :edit, {:id => critter.to_param}, valid_session
      expect(assigns(:critter)).to eq(critter)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Critter" do
        expect {
          post :create, {:critter => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved critter as @critter" do
        post :create, {:critter => invalid_attributes}, valid_session
        expect(assigns(:critter)).to be_a_new(Critter)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested critter" do
        critter = Critter.create! valid_attributes
        put :update, {:id => critter.to_param, :critter => new_attributes}, valid_session
        critter.reload
      ...
      it "assigns the requested critter as @critter" do
        critter = Critter.create! valid_attributes
        put :update, {:id => critter.to_param, :critter => valid_attributes}, valid_session
        expect(assigns(:critter)).to eq(critter)
      end
    ...
    context "with invalid params" do
      it "assigns the critter as @critter" do
        critter = Critter.create! valid_attributes
        put :update, {:id => critter.to_param, :critter => invalid_attributes}, valid_session
        expect(assigns(:critter)).to eq(critter)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested critter" do
      critter = Critter.create! valid_attributes
      expect {
        delete :destroy, {:id => critter.to_param}, valid_session
      }.to change(Critter, :count).by(-1)
    end
